...
const warrantySchema = new mongoose.Schema({
  panels: { type: String, default: 'As per manufacturer warranty', trim: true, maxlength: 250 },
  inverter: { type: String, default: 'As per manufacturer warranty', trim: true, maxlength: 250 },
  battery: { type: String, default: 'As per manufacturer warranty', trim: true, maxlength: 250 },
  workmanship: { type: String, default: '1 year workmanship warranty', trim: true, maxlength: 250 },
}, { _id: false });
...
const quotationSchema = new mongoose.Schema(
  {
    ...
    meterPhase: { type: String, default: 'unknown', enum: ['single-phase', 'three-phase', 'unknown'] },
    roofType: { type: String, default: 'rcc', enum: ['rcc', 'metal-shed', 'ground-mount', 'other'] },
    ...
    siteSurveyStatus: { type: String, default: 'required', enum: ['required', 'completed', 'not-required'] },
    items: [lineItemSchema],
    subtotal: { type: Number, required: true, default: 0 },
    discount: { type: Number, default: 0, min: 0 },
    discountType: { type: String, default: 'percent', enum: ['percent', 'fixed'] },
    taxLabel: { type: String, default: 'Applicable taxes', trim: true, maxlength: 100 },
    ...
    paymentSchedule: { type: [paymentMilestoneSchema], default: () => [
